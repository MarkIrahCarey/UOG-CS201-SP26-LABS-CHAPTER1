...
Use the following equation (πr^2): 3.14 * radius ** 2
...
It must have at least asked the user for the following information:
- Name
- Age
- Favorite Color
- Hobby

Try to be creative when creating the users profile!
